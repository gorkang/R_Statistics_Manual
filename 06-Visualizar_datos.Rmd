...
Vamos a usar la siguiente [base de datos](Data/datos_Visualizar_datos.csv).
...
datos = read_csv("Data/datos_Visualizar_datos.csv"); datos  
  
# A algunas de las funciones no les gustan las tibbles! 
datos2 = read.csv("Data/datos_Visualizar_datos.csv") 
...
```{r}
datos = read_csv("Data/datos_Visualizar_datos.csv")
