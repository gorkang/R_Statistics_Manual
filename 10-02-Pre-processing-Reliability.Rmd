...
* Garcia's function para ordenar 
...
***
We use the following [dataset](Data/Pre-processing/Reliability_data_file.csv).

***  
```{r}
temp = read_csv("Data/Pre-processing/Reliability_data_file.csv")
temp = temp[-1] 
...
# Commented here because execution time is non-trivial
# set.seed(1)
