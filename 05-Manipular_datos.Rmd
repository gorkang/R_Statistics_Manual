...
***
* Vamos a usar la siguiente [base de datos](Data/Manipular_datos/datos.csv).
...
### Leer datos
```{r, message=FALSE, warning=FALSE}
raw_data = read_csv("Data/Manipular_datos/datos.csv"); raw_data

```

### Guardar DB a archivo
```{r}
write_csv(raw_data, "Data/Manipular_datos/datos_guardados.csv")
...
![FROM https://xkcd.com/208/](https://imgs.xkcd.com/comics/regular_expressions.png)
...
### Ordenar DB
```{r}
#data_long_RAW %>% arrange(desc(VD))
data_long_RAW %>% arrange(VD_t, VD) 
```
...
datos1 = read_csv("Data/Manipular_datos/datos_1.csv"); datos1
datos2 = read_csv("Data/Manipular_datos/datos_2.csv"); datos2
