...
Para muchos de los análisis que vienen a continuación hemos creado una base de datos, la cual puedes descargar [Aquí](Data/ANOVA/data file.csv).
...
#Importar dataframe
df = read_csv("Data/ANOVA/data_file.csv")
...
Esta vez trabajaremos con otra base de datos, la cual puedes descargar [Aquí](Data/ANOVA/data aov1.csv).
...
#Importar dataframe
df = read_csv("Data/ANOVA/data_aov1.csv")
...
Esta vez nuevamente trabajaremos con otra base de datos, la cual puedes descargar [Aquí](Data/ANOVA/data aov2.csv).
...
#Importar dataframe
df = read_csv("Data/ANOVA/data_aov2.csv")
